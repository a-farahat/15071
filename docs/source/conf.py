...
project = '15.071 Software Guide'

author = '15.071 Teaching Team'

copyright = '2022, 15.071 Teaching Team'

version = '0.1'

release = '15071.Spring2022a'
...
html_theme_options = {
    'description': 'A succinct guide to using Python and Gurobi in The Analytics Edge',
    'fixed_sidebar': 'True',
    'show_powered_by': 'False',
    'sidebar_width': '22%', # default 220px
    'page_width' : '94%', # default 940px
}
